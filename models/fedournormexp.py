...
class FedOurNormExp(FederatedModel):
    NAME = 'fedournormexp'
    COMPATIBILITY = ['homogeneity']

    def __init__(self, nets_list,args, transform):
        super(FedOurNormExp, self).__init__(nets_list, args, transform)
        self.t = args.t
        self.w = args.w
        self.norm_dict = {}
    ...
    def norm_aggregate_nets(self):
        ...
        online_clients_norm_weight = [online_clients_mean_norm /(item * self.w) for item in online_clients_norm]
