...
def get_parser() -> ArgumentParser:
    parser = ArgumentParser(description='Federated learning via FedOursNoExp.')
    add_management_args(parser)
    add_experiment_args(parser)
    return parser


class FedOursNoExp(FederatedModel):
    NAME = 'fedoursnoexp'
    COMPATIBILITY = ['homogeneity']

    def __init__(self, nets_list,args, transform):
        super(FedOursNoExp, self).__init__(nets_list, args, transform)
        self.t = args.t
        self.w = args.w
        self.norm_dict = {}
